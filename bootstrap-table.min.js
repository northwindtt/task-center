                ...
                for (var g = 0; g < b.header.fields.length; g++)
                  if (b.header.searchables[g]) {
                    ...
                    if ("string" == typeof j) {
                      ...
                      k &&
                        k.searchFormatter &&
                        (i = h(k, b.header.formatters[g], [i, d, f], i));
                    } else i = d[j];
          ...
          var q =
            "string" == typeof this.options.pageList
              ? this.options.pageList
                  ...
                  .split(",")
              : this.options.pageList;
          a.inArray(this.options.formatAllRows().toLowerCase(), q) > -1 &&
            (n = !0);
        }
        (this.totalPages =
          ...
          a.each(p, function (a, b) {
            if (
              ...
              (d = n
                ...
                : ""),
                r.push(
                  c('<li%s><a href="javascript:void(0)">%s</a></li>', d, b)
                );
            }
          }),
            r.push("</ul></span>"),
    ...
    (p.prototype.initBody = function (b) {
      ...
      for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
        var l,
          ...
          s = [];
        if (
          ((o = h(this.options, this.options.rowStyle, [n, k], o)), o && o.css)
        )
          ...
          a.each(this.header.fields, function (b, e) {
            ...
            if (
              ...
              if (
                ...
                n["_" + e + "_class"] &&
                  (s = c(' class="%s"', n["_" + e + "_class"])),
                n["_" + e + "_rowspan"] &&
                  (u = c(' rowspan="%s"', n["_" + e + "_rowspan"])),
                n["_" + e + "_colspan"] &&
                  (v = c(' colspan="%s"', n["_" + e + "_colspan"])),
                n["_" + e + "_title"] &&
                ...
                x.checkbox || x.radio
                  ? ((l = x.checkbox ? "checkbox" : l),
                    ...
                    (i = [
                      ...
                      "<input" +
                        ...
                        c(
                          ' checked="%s"',
                          j === !0 || (j && j.checked) ? "checked" : void 0
                        ) +
                        c(
                          ' disabled="%s"',
                          !x.checkboxEnabled || (j && j.disabled)
                            ? "disabled"
                            : void 0
                        ) +
                        " />",
                  ...
                  : ((j =
                    ...
                    (i = f.options.cardView
                      ...
                      : [
                          c("<td%s %s %s %s %s %s %s>", r, s, o, t, u, v, w),
                          j,
                          "</td>",
                        ].join("")),
                    f.options.cardView &&
          ...
          .on("click", function () {
            ...
            if (d.next().is("tr.detail-view"))
              b
                ...
                .attr(
                  "class",
                  c("%s %s", f.options.iconsPrefix, f.options.icons.detailOpen)
                ),
                d.next().remove(),
              ...
              b
                ...
                .attr(
                  "class",
                  c("%s %s", f.options.iconsPrefix, f.options.icons.detailClose)
                ),
                d.after(
                  c(
